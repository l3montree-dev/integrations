...
declare function filterRequestHeaders(headers: IncomingHttpHeaders, forwardAdditionalHeaders?: string[]): Headers;
/**
 ...
 */
declare function createApiHandler(options: CreateApiHandlerOptions): (req: NextApiRequest, res: NextApiResponse<string>) => Promise<void>;

export { config, createApiHandler, filterRequestHeaders };
